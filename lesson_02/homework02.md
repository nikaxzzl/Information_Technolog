...
| Группа | РПО3 |
| Номер работы | №3 |
| Тема работы | **Тема 04 · Google Analytics 4** и **Тема 05 · Свой сайт, Vercel и Google Tag** на сайте курса. Работа сдаётся скриншотами из своего ресурса GA4 |
| Дата сдачи | 25.05 |
| Ветка | main (делала в ветке hw02, потом слила) |
